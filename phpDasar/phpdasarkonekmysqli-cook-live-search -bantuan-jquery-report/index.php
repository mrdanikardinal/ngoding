...
<body>
    <a href="logout.php" class="logout">Logout</a>|<a href="cetak.php" target="_blank">Print Out</a>
    ...
    <form action="" method="post">
        ...
        <img src="loader-gif/salmon-loading.gif" alt="" class="loader">
    <br>
    </form>
    <br>
    <br>
    ...
    <script src="js/jqery-offline.js"></script>
